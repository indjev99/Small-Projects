...
void find_stats()
{
    std::pair<double,double> expAndVarOfGrades=find_exp_and_var(vals);
    ...
    std::cout<<"Values:  "<<"Expected: "<<expAndVarOfGrades.first<<" Variance: "<<expAndVarOfGrades.second<<std::endl;
